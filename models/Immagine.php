...
//            [['path'], 'file', 'skipOnEmpty' => false, 'extensions' => 'png, jpg'],
    ...
    {
        return $this->hasMany(FaldoneImmagine::className(), ['immagine_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Faldone::className(), ['id' => 'faldone_id'])->viaTable('faldone_immagine', ['immagine_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(FascicoloImmagine::className(), ['immagine_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Fascicolo::className(), ['id' => 'fascicolo_id'])->viaTable('fascicolo_immagine', ['immagine_id' => 'id']);
    }
    ...
    public function afterDelete()
    {
        ...
        unlink(PATHURBI . '/web/uploads/' . $this->path );
    }
}
