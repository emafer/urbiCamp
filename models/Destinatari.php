...
/**
 * This is the model class for table "destinatari".
 *
 ...
 */
class Destinatari extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return \app\query\DestinatariQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\query\DestinatariQuery(get_called_class());
    }
}
