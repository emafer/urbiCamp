...
/**
 * This is the model class for table "interessati".
 *
 ...
 */
class Interessato extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * {@inheritdoc}
     * @return \app\query\InteressatoQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\query\InteressatoQuery(get_called_class());
    }
}
